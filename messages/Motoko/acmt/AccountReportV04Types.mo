module {
	...
	public type AccountReport28 = {
		Grp : ?[Group4];

		Acct : CustomerAccount5;
		Mndt : ?[OperationMandate4];

		TrfAcctSvcrId : ?BranchAndFinancialInstitutionIdentification6;
		UndrlygMstrAgrmt : ?ContractDocument1;
		RefAcct : ?CashAccount40;
		CtrctDts : ?AccountContract3;
		BalTrfAcct : ?AccountForAction1;
	};
