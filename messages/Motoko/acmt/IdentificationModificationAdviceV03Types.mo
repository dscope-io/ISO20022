module {
	...
	public type IdentificationInformation4 = {
		Agt : ?BranchAndFinancialInstitutionIdentification6;
		Pty : ?PartyIdentification135;
		Acct : ?CashAccount40;
	};

	public type IdentificationModification4 = {
		Id : Text;
		OrgnlPtyAndAcctId : ?IdentificationInformation4;
		UpdtdPtyAndAcctId : IdentificationInformation4;
		AddtlInf : ?Text;
	};

	public type PaymentIdentification5 = {
		ClrSysRef : ?Text;
		TxId : ?Text;
		UETR : ?Text;
		InstrId : ?Text;
		FrstAgt : ?BranchAndFinancialInstitutionIdentification6;
		EndToEndId : Text;
	};

	public type OriginalTransactionReference30 = {
		OrgnlTx : ?[PaymentIdentification5];
	...
	public type IdentificationAssignment3 = {
		FrstAgt : ?BranchAndFinancialInstitutionIdentification6;
	...
	public type IdentificationModificationAdviceV03 = {
		Mod : [IdentificationModification4];
		OrgnlTxRef : ?OriginalTransactionReference30;
		Assgnmt : IdentificationAssignment3;
