module {
	...
	public type IdentificationVerification4 = {
		Id : Text;
		PtyAndAcctId : IdentificationInformation4;
	};
	...
	public type IdentificationVerificationRequestV03 = {
		Assgnmt : IdentificationAssignment3;
		Vrfctn : [IdentificationVerification4];
