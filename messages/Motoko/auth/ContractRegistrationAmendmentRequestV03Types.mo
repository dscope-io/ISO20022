module {
	...
	public type RegisteredContract14 = {
		Attchmnt : ?[DocumentGeneralInformation5];

		PmtSchdlTp : ?PaymentScheduleType2Choice;
		RegdCtrctAmdmntId : Text;
		Prty : Priority2Code;
		OrgnlRegdCtrctId : Text;
	...
	public type RegisteredContract13 = {
		RegdCtrctAmdmnt : [RegisteredContract14];
		RptgPty : TradeParty5;
		RegnAgt : BranchAndFinancialInstitutionIdentification6;
		SplmtryData : ?[SupplementaryData1];

		CtrctRegnAmdmntId : Text;
	};

	public type ContractRegistrationAmendmentRequestV03 = {
		GrpHdr : CurrencyControlHeader4;
		SplmtryData : ?[SupplementaryData1];

		CtrctRegnAmdmnt : [RegisteredContract13];
	};
