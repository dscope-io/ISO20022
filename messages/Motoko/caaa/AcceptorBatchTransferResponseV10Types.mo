module {
	...
	public type CardPaymentTransactionAdviceResponse5 = {
		Rspn : Response1Code;
	...
	public type CardPaymentDataSet30 = {
		Tx : CardPaymentTransactionAdviceResponse5;
		TxSeqCntr : Text;
		Envt : CardPaymentEnvironment78;
		TxRspn : ResponseType10;
	};
	...
	public type CardPaymentDataSet31 = {
		DataSetInitr : ?GenericIdentification176;
		RjctdTx : ?[CardPaymentDataSet30];

		DataSetRslt : ResponseType10;
		DataSetId : DataSetIdentification5;
		RsmdRjctn : ?[CardPaymentDataSet30];

		RmvDataSet : ?Bool;
		SspdTx : ?[CardPaymentDataSet30];

		RsmdApprvl : ?[CardPaymentDataSet30];

		TxTtls : [TransactionTotals12];
	};

	public type CardPaymentBatchTransferResponse9 = {
		DataSet : ?[CardPaymentDataSet31];
	...
	public type AcceptorBatchTransferResponseV10 = {
		Hdr : Header56;
		BtchTrfRspn : CardPaymentBatchTransferResponse9;
