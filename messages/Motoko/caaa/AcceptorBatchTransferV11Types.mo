module {
	...
	public type CardPaymentDataSetTransaction39 = {
	...
	public type CardPaymentTransaction121 = {
		InitrTxId : ?Text;
		RcptTxId : ?Text;
		TxId : TransactionIdentifier1;
		MrchntRefData : ?Text;
	...
	public type CardPaymentDataSetTransaction38 = {
		Tx : CardPaymentTransaction121;
		TxSeqCntr : Text;
		Envt : CardPaymentEnvironment78;
		Tracblt : ?[Traceability8];
	...
	public type AccountChoiceMethod1Code = {
		#ACSL;
		#ENTR;
		#IMAC;
		#IMPL;
	...
	public type PartyIdentification177Choice = {
		AnyBIC : ?Text;
		PrtryId : ?GenericIdentification1;
	};

	public type AccountIdentification54Choice = {
		BBAN : ?Text;
		Card : ?Text;
		Dmst : ?Text;
		IBAN : ?Text;
	...
	public type CardAccount16 = {
		Ccy : ?Text;
		SelctnMtd : ?AccountChoiceMethod1Code;
		AcctOwnr : ?NameAndAddress3;
		Svcr : ?PartyIdentification177Choice;
		AcctNm : ?Text;
		SelctdAcctTp : ?CardAccountType3Code;
		AcctIdr : ?AccountIdentification54Choice;
	};

	public type CardPaymentTransaction119 = {
		OrgnlTx : ?CardPaymentTransaction122;
		InitrTxId : ?Text;
		LastTxFlg : ?Bool;
		CardPrgrmmApld : ?Text;
		...
		TxTp : ?CardPaymentServiceType12Code;
		MrchntCITId : ?Text;
		AcctFr : ?CardAccount16;
		AcctTo : ?CardAccount16;
		MrchntRefData : ?Text;
		TxCaptr : ?Bool;
		SaleRefId : ?Text;
		MrchntCtgyCd : ?Text;
	...
	public type CardPaymentDataSetTransaction40 = {
		Tx : CardPaymentTransaction119;
		TxSeqCntr : Text;
		Envt : CardPaymentEnvironment78;
		Tracblt : ?[Traceability8];
	...
	public type TokenRequestComponent2 = {
		TxSeqCntr : Text;
		Envt : CardPaymentEnvironment78;
	};
	...
	public type CardPaymentTransaction118 = {
		OrgnlTx : ?CardPaymentTransaction122;
		InitrTxId : ?Text;
		LastTxFlg : ?Bool;
	...
	public type CardPaymentDataSetTransaction41 = {
		Tx : CardPaymentTransaction118;
		TxSeqCntr : Text;
		Envt : CardPaymentEnvironment78;
		Tracblt : ?[Traceability8];
	...
	public type CardPaymentDataSetTransaction10Choice = {
		Cxl : ?CardPaymentDataSetTransaction39;
		AuthstnRspn : ?CardPaymentDataSetTransaction38;
		AuthstnReq : ?CardPaymentDataSetTransaction40;
		TknReq : ?TokenRequestComponent2;
		Cmpltn : ?CardPaymentDataSetTransaction41;
		TknRspn : ?TokenRequestComponent2;
	};

	public type DataSetCategory8Code = {
		#AKCP;
		#AQPR;
		#DLGT;
		#MGTP;
	...
	public type DataSetIdentification5 = {
		Nm : Text;
	...
	public type TypeTransactionTotals2Code = {
		#CRDR;
		#CRDT;
		#DBTR;
		#DEBT;
	...
	public type TransactionTotals12 = {
	...
	public type CardPaymentDataSet29 = {
		Tx : [CardPaymentDataSetTransaction10Choice];
		DataSetInitr : ?GenericIdentification176;
		Tracblt : ?[Traceability8];

		DataSetId : DataSetIdentification5;
		CmonData : ?CommonData11;
		TxTtls : [TransactionTotals12];
	};

	public type CardPaymentBatchTransfer10 = {
		DataSet : ?[CardPaymentDataSet29];
	...
	public type AcceptorBatchTransferV11 = {
		Hdr : Header56;
		BtchTrf : CardPaymentBatchTransfer10;
