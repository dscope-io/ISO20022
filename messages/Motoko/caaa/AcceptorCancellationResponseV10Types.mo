module {
	...
	public type CardPaymentTransaction117 = {
		InitrTxId : ?Text;
		RcptTxId : ?Text;
	...
	public type CardPaymentTransaction113 = {
		AuthstnRslt : AuthorisationResult19;
		Actn : ?[Action12];

	};

	public type AcceptorCancellationResponse10 = {
		Tx : CardPaymentTransaction117;
		Envt : CardPaymentEnvironment78;
		TxRspn : CardPaymentTransaction113;
	};
	...
	public type AcceptorCancellationResponseV10 = {
		Hdr : Header59;
		CxlRspn : AcceptorCancellationResponse10;
