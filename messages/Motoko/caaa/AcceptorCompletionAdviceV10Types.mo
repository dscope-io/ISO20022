module {
	...
	public type AuthorisationResult15 = {
		AuthstnNtty : ?GenericIdentification90;
		RspnToAuthstn : ResponseType10;
		AuthstnCd : ?Text;
	};
	...
	public type AccountIdentification39Choice = {
		BBAN : ?Text;
		Card : ?Text;
		Dmst : ?Text;
		IBAN : ?Text;
	...
	public type CardAccount15 = {
		...
		AcctIdr : ?AccountIdentification39Choice;
	};
	...
	public type RecurringTransaction2 = {
		SeqNb : ?Float;
	...
	public type ContentInformationType25 = {
	...
	public type ActionMessage8 = {
		MsgCnttSgntr : ?ContentInformationType25;
	...
	public type CurrencyConversion20 = {
		SrcCcy : CurrencyDetails2;
		DclrtnDtls : ?[ActionMessage8];
	...
	public type CurrencyConversion21 = {
		AccptdByCrdhldr : ?Bool;
		Convs : ?CurrencyConversion20;
	};

	public type OnLineReason1Code = {
		#CBIN;
		#CPAN;
		#CRCY;
		#EXFL;
	...
	public type CardPaymentTransactionDetails49 = {
		Ccy : ?Text;
		ReqdAmt : ?Float;
		VldtyDt : ?Int;
		InvcAmt : ?Float;
		...
		Instlmt : ?RecurringTransaction2;
		CcyConvsRslt : ?CurrencyConversion21;
		UattnddLvlCtgy : ?Text;
		...
		DlvryLctn : ?Text;
		PdctCdSetId : ?Text;
		AddtlInf : ?[ExternallyDefinedData2];
	...
	public type CardPaymentTransaction103 = {
		OrgnlTx : ?CardPaymentTransaction106;
		InitrTxId : ?Text;
		LastTxFlg : ?Bool;
		AuthstnRslt : ?AuthorisationResult15;
		CardPrgrmmApld : ?Text;
		CstmrCnsnt : ?[Bool];
		...
		TxTp : ?CardPaymentServiceType12Code;
		MrchntOvrrd : ?Bool;
		AcctFr : ?CardAccount15;
		AcctTo : ?CardAccount15;
		...
		SvcAttr : ?CardPaymentServiceType3Code;
		TxDtls : CardPaymentTransactionDetails49;
	...
	public type AcceptorCompletionAdvice10 = {
		Tx : CardPaymentTransaction103;
	...
	public type AcceptorCompletionAdviceV10 = {
		Hdr : Header59;
		CmpltnAdvc : AcceptorCompletionAdvice10;
