module {
	...
	public type NonFinancialRequestType1Code = {
		#ACQR;
		#PARQ;
		#RISK;
		#TOKN;
	...
	public type NonFinancialRequestContentComponent2 = {
		Tx : ?CardPaymentTransaction119;
		NonFinReqTp : [NonFinancialRequestType1Code];
	};
	...
	public type NonFinancialRequestComponent2 = {
		Envt : CardPaymentEnvironment78;
		SplmtryData : ?[SupplementaryData1];

		NonFinReqCntt : NonFinancialRequestContentComponent2;
	...
	public type AcceptorNonFinancialRequestV02 = {
		Hdr : Header59;
		NonFinReq : NonFinancialRequestComponent2;
