module {
	...
	public type NonFinancialResponseRisk1Code = {
		#DECL;
		#NCHG;
		#ONLN;
	};
	...
	public type NonFinancialResponseContentComponent2 = {
		Actn : ?[Action12];

		Rspn : ResponseType11;
		RskMgmtRslt : ?NonFinancialResponseRisk1Code;
		NonFinReqTp : NonFinancialRequestType1Code;
		AcqrrSelctd : ?Acquirer10;
	};
	...
	public type NonFinancialResponseComponent2 = {
		Envt : CardPaymentEnvironment78;
		Rspn : ResponseType11;
		RspnCntt : [NonFinancialResponseContentComponent2];
	...
	public type AcceptorNonFinancialResponseV02 = {
		Hdr : Header59;
		NonFinRspn : NonFinancialResponseComponent2;
