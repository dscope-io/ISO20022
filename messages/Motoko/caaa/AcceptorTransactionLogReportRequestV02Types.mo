module {
	...
	public type ReportGetTotalsRequest1 = {
		TtlDtls : ?TotalDetails1Code;
		TtlFltr : ?TotalFilter1;
	};
	...
	public type SearchAnd1 = {
		Val : Text;
		Trgt : Text;
		Oprtr : Operator1Code;
	};

	public type SearchOr1 = {
		SchAnd : [SearchAnd1];
	};

	public type SearchCriteria1 = {
		SchOr : [SearchOr1];
	};

	public type CriteriaOrder1 = {
		Trgt : Text;
	};

	public type SearchOutputOrder1 = {
		CritOrdr : [CriteriaOrder1];
	};

	public type ReportTransactionRequest1 = {
		SchCrit : [SearchCriteria1];
		SchOutptOrdr : ?SearchOutputOrder1;
		DscndgOrdr : ?Bool;
		BlckStart : ?Float;
		BlckStop : ?Float;
	};

	public type RetailerService6Code = {
		#RPAQ;
		#RPTQ;
	};
	...
	public type ReportRequest5 = {
		Envt : CardPaymentEnvironment78;
		RptGetTtlsReq : ?ReportGetTotalsRequest1;
		SplmtryData : ?[SupplementaryData1];

		RptTxReq : ?ReportTransactionRequest1;
		SvcCntt : RetailerService6Code;
	...
	public type AcceptorTransactionLogReportRequestV02 = {
		Hdr : Header59;
		RptReq : ReportRequest5;
