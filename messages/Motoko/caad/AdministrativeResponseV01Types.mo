module {
	...
	public type AdministrativeType1Code = {
		#OTHN;
		#OTHP;
		#TEXT;
	};

	public type AdditionalData2 = {
		Tp : ?Text;
		Dtls : ?[AdditionalData1];

	};

	public type Transaction144 = {
		AltrnMsgRsn : ?[Text];
		...
		TxDesc : ?Text;
		AdmstvTp : AdministrativeType1Code;
		AddtlData : ?[AdditionalData2];
	...
	public type AdministrativeResponse1 = {
		Tx : Transaction144;
	...
	public type AdministrativeResponseV01 = {
		Hdr : Header66;
		Body : AdministrativeResponse1;
