module {
	...
	public type ReportContent1Choice = {
		Txt : ?Text;
	...
	public type ReportContent1 = {
		RptLineSeq : ?Text;
		FrmtdCntt : ReportContent1Choice;
	};

	public type OutputFormat5Code = {
		#CSVF;
		#EDIF;
		#HTML;
		#JPEG;
	...
	public type ReportData6 = {
		...
		Frmt : ?OutputFormat5Code;
		Qlfr : ?Text;
		ConttnInd : ?Bool;
		TtlOcrncs : ?Text;
		Frqcy : ?Frequency17Code;
