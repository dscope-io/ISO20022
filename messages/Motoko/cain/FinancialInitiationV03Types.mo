module {
	...
	public type TransactionIdentification16 = {
		LclDt : Int;
		LclTm : ?Int;
		AcqrrRefNb : ?Text;
		AcqrrRefData : ?Text;
	...
	public type Transaction145 = {
		AltrnMsgRsn : ?[Text];

		OrgnlAddtlFee : ?[AdditionalFee2];

		TxId : TransactionIdentification16;
		TxTp : Text;
	...
	public type FinancialInitiation2 = {
		Tx : Transaction145;
	...
	public type FinancialInitiationV03 = {
		Hdr : Header62;
		Body : FinancialInitiation2;
