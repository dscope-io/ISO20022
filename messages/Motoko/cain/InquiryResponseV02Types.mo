module {
	...
	public type AccountStatementDetails2 = {
		TxPstngDt : ?Int;
		ShrtTxDesc : ?Text;
		TxDt : Int;
		CrdhldrBllgAmt : ?Amount7;
		CdtDbt : ?CreditDebit3Code;
		TxAmt : ?Amount7;
		LngTxDesc : ?Text;
		AccptrNmAndLctn : ?Text;
		PdgInd : ?Bool;
	};

	public type AccountStatementData2 = {
		AcctStmt : ?[AccountStatementDetails2];

		StmtDt : ?Int;
		StmtTm : ?Int;
	};

	public type BalanceType15Code = {
		#AMOH;
		#AMTD;
		#AMTO;
		#AVLB;
	...
	public type Balance28 = {
		Tp : BalanceType15Code;
		Amt : Float;
		Ccy : ?Text;
		BalDt : ?Int;
		OthrTp : ?Text;
	...
	public type Transaction132 = {
		RcncltnAmt : ?Amount15;
		TxId : TransactionIdentification18;
		TxTp : Text;
		AcctFr : ?AccountDetails3;
		AcctStmtData : ?[AccountStatementData2];

		AcctBal : ?[AccountBalance2];
	...
	public type ProcessingResult17 = {
	...
	public type InquiryResponseV02 = {
		Hdr : Header60;
		Body : InquiryResponse2;
