module {
	...
	public type MessageFunction45Code = {
		#ADVC;
		#INST;
		#NOTI;
		#REQU;
	...
	public type RetrievalInitiation2 = {
		Tx : ?Transaction136;
		...
		RtrvlFlfmtDstn : ?PartyIdentification258;
		Cntxt : Context15;
	};
	...
	public type RetrievalInitiationV02 = {
		Hdr : Header67;
		Body : RetrievalInitiation2;
