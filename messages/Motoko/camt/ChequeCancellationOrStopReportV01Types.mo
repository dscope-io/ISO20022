module {
	...
	public type ChequeCancellationStatus1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};
	...
	public type ChequeCancellationStatus1 = {
		Sts : ChequeCancellationStatus1Choice;
	...
	public type Cheque14 = {
		...
		ChqCxlOrStopSts : ChequeCancellationStatus1;
	...
	public type ChequeCancellationOrStopReportV01 = {
		Chq : [Cheque14];
