module {
	...
	public type ChequeCancellationReason1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type ChequePartyRole1Code = {
		#DWEA;
		#DWRA;
		#PAYE;
		#PAYR;
	...
	public type ChequeCancellationReason1 = {
		Rsn : ChequeCancellationReason1Choice;
		Orgtr : ?ChequePartyRole1Code;
		AddtlInf : ?Text;
	};
	...
	public type Cheque15 = {
		Amt : ActiveCurrencyAndAmount;
		DrwrAgtAcct : ?CashAccount40;
		StlDt : ?Int;
		OrgnlInstrId : ?Text;
		Pyee : ?PartyIdentification135;
		PyeeAcct : ?CashAccount40;
		ChqCxlOrStopRsn : ?ChequeCancellationReason1;
		FctvDt : ?DateAndDateTime2Choice;
		InstrId : ?Text;
		DrwrAgt : ?BranchAndFinancialInstitutionIdentification6;
		IsseDt : Int;
		ChqNb : Text;
	};

	public type GroupHeader103 = {
		CtrlSum : ?Float;
		MsgId : Text;
		CreDtTm : Int;
		NbOfChqs : Text;
	...
	public type ChequeCancellationOrStopRequestV01 = {
		Chq : [Cheque15];
		GrpHdr : GroupHeader103;
