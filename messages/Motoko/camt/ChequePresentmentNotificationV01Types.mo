module {
	...
	public type InstructionForChequeAgent1 = {
		Cd : ?Text;
		InstrInf : ?Text;
	};
	...
	public type ChequePresentmentNotificationV01 = {
		Chq : [Cheque13];
