module {
	...
	public type SettlementInstruction13 = {
	...
	public type MissingCover5 = {
		CoverCrrctn : ?SettlementInstruction13;
		MssngCoverInd : ?Bool;
	};
	...
	public type InstructionForAssignee1 = {
		Cd : ?Text;
		InstrInf : ?Text;
	};
	...
	public type ClaimNonReceiptV09 = {
		Assgnmt : CaseAssignment5;
		Case : ?Case5;
		CoverDtls : ?MissingCover5;
