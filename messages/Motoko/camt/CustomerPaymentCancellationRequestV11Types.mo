module {
	...
	public type PaymentTransaction140 = {
	...
	public type OriginalPaymentInstruction44 = {
		Case : ?Case5;
		CtrlSum : ?Float;
		OrgnlPmtInfId : Text;
		NbOfTxs : ?Text;
		TxInf : ?[PaymentTransaction140];
	...
	public type UnderlyingTransaction30 = {
		OrgnlPmtInfAndCxl : ?[OriginalPaymentInstruction44];
	...
	public type CustomerPaymentCancellationRequestV11 = {
		Assgnmt : CaseAssignment5;
		Case : ?Case5;
		SplmtryData : ?[SupplementaryData1];

		Undrlyg : [UnderlyingTransaction30];
