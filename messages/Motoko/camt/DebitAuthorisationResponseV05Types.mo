module {
	...
	public type DebitAuthorisationConfirmation2 = {
		Rsn : ?Text;
		DbtAuthstn : ?Bool;
		AmtToDbt : ?ActiveCurrencyAndAmount;
		ValDtToDbt : ?Int;
	};
	...
	public type DebitAuthorisationResponseV05 = {
		Assgnmt : CaseAssignment5;
		Case : ?Case5;
		Conf : DebitAuthorisationConfirmation2;
