module {
	...
	public type CancellationReason33Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type PaymentCancellationReason5 = {
		Rsn : ?CancellationReason33Choice;
		Orgtr : ?PartyIdentification135;
		AddtlInf : ?[Text];

	};

	public type PaymentTransaction137 = {
		OrgnlTxRef : ?OriginalTransactionReference35;
		OrgnlClrSysRef : ?Text;
		OrgnlInstrId : ?Text;
		Case : ?Case5;
		OrgnlEndToEndId : ?Text;
		Assgne : ?BranchAndFinancialInstitutionIdentification6;
		Assgnr : ?BranchAndFinancialInstitutionIdentification6;
		...
		CxlRsnInf : ?[PaymentCancellationReason5];

		CxlId : ?Text;
	};

	public type OriginalGroupHeader15 = {
		GrpCxlId : ?Text;
		Case : ?Case5;
		CtrlSum : ?Float;
		GrpCxl : ?Bool;
	...
	public type UnderlyingTransaction28 = {
		TxInf : ?[PaymentTransaction137];

		OrgnlGrpInfAndCxl : ?OriginalGroupHeader15;
	};

	public type ControlData1 = {
		CtrlSum : ?Float;
		NbOfTxs : Text;
	};

	public type FIToFIPaymentCancellationRequestV10 = {
		Assgnmt : CaseAssignment5;
		Case : ?Case5;
		SplmtryData : ?[SupplementaryData1];

		Undrlyg : [UnderlyingTransaction28];
		CtrlData : ?ControlData1;
	};
