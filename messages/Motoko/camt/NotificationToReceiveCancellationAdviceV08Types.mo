module {
	public type NotificationCancellationReason1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};
	...
	public type NotificationCancellationReason1 = {
		Rsn : ?NotificationCancellationReason1Choice;
	...
	public type OriginalItemReference6 = {
		Acct : ?CashAccount40;
		Dbtr : ?Party40Choice;
		AcctOwnr : ?Party40Choice;
		AcctSvcr : ?BranchAndFinancialInstitutionIdentification6;
		Purp : ?Purpose2Choice;
		IntrmyAgt : ?BranchAndFinancialInstitutionIdentification6;
	...
	public type OriginalItem7 = {
		Amt : ActiveOrHistoricCurrencyAndAmount;
		XpctdValDt : ?Int;
		OrgnlEndToEndId : ?Text;
		UETR : ?Text;
		OrgnlItmRef : ?OriginalItemReference6;
		OrgnlItmId : Text;
	};

	public type OriginalNotificationReference12 = {
		XpctdValDt : ?Int;
		Acct : ?CashAccount40;
		Dbtr : ?Party40Choice;
		AcctOwnr : ?Party40Choice;
		...
		DbtrAgt : ?BranchAndFinancialInstitutionIdentification6;
		TtlAmt : ?ActiveOrHistoricCurrencyAndAmount;
		OrgnlItm : [OriginalItem7];
		RltdAcct : ?CashAccount40;
	};

	public type OriginalNotification14 = {
		NtfctnCxl : ?Bool;
		OrgnlNtfctnRef : ?[OriginalNotificationReference12];
	...
	public type NotificationToReceiveCancellationAdviceV08 = {
		CxlRsn : ?NotificationCancellationReason1;
		GrpHdr : GroupHeader77;
		SplmtryData : ?[SupplementaryData1];

		OrgnlNtfctn : OriginalNotification14;
	};
