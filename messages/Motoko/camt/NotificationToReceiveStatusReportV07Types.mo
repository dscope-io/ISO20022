module {
	public type NotificationStatus3Code = {
		#NRCD;
		#RCBD;
		#RCVD;
	};
	...
	public type OriginalItemAndStatus7 = {
		Amt : ActiveOrHistoricCurrencyAndAmount;
		XpctdValDt : ?Int;
		OrgnlEndToEndId : ?Text;
		ItmSts : NotificationStatus3Code;
	...
	public type OriginalNotificationReference11 = {
		XpctdValDt : ?Int;
		Acct : ?CashAccount40;
		Dbtr : ?Party40Choice;
		AcctOwnr : ?Party40Choice;
		...
		IntrmyAgt : ?BranchAndFinancialInstitutionIdentification6;
		DbtrAgt : ?BranchAndFinancialInstitutionIdentification6;
		OrgnlItmAndSts : [OriginalItemAndStatus7];
		TtlAmt : ?ActiveOrHistoricCurrencyAndAmount;
		RltdAcct : ?CashAccount40;
	};

	public type OriginalNotification13 = {
		NtfctnSts : ?NotificationStatus3Code;
		OrgnlNtfctnRef : ?[OriginalNotificationReference11];
	...
	public type GroupHeader84 = {
		MsgRcpt : ?Party40Choice;
		MsgId : Text;
		CreDtTm : Int;
	};
	...
	public type NotificationToReceiveStatusReportV07 = {
		OrgnlNtfctnAndSts : OriginalNotification13;
