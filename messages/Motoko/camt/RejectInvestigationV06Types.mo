module {
	...
	public type InvestigationRejection1Code = {
		#MROI;
		#NAUT;
		#NFND;
		#PCOR;
	...
	public type InvestigationRejectionJustification1 = {
		RjctnRsn : InvestigationRejection1Code;
	};
	...
	public type RejectInvestigationV06 = {
