module {
	...
	public type SettlementMethod2Code = {
		#CLRG;
		#INDA;
		#INGA;
	};
	...
	public type SettlementInstruction14 = {
		SttlmMtd : SettlementMethod2Code;
	...
	public type DirectDebitTransactionInformation29 = {
		ChrgsInf : ?[Charges7];
	...
	public type FIToFICustomerDirectDebitV09 = {
		GrpHdr : GroupHeader98;
		SplmtryData : ?[SupplementaryData1];

		DrctDbtTxInf : [DirectDebitTransactionInformation29];
	};
