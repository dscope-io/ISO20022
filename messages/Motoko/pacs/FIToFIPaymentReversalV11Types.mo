module {
	...
	public type GroupHeader97 = {
		...
		BtchBookg : ?Bool;
		IntrBkSttlmDt : ?Int;
		TtlRvsdIntrBkSttlmAmt : ?ActiveCurrencyAndAmount;
	...
	public type PaymentTransaction135 = {
		...
		RvsdIntrBkSttlmAmt : ActiveCurrencyAndAmount;
		OrgnlTxId : ?Text;
		OrgnlUETR : ?Text;
	...
	public type FIToFIPaymentReversalV11 = {
		GrpHdr : GroupHeader97;
		SplmtryData : ?[SupplementaryData1];

		TxInf : ?[PaymentTransaction135];
