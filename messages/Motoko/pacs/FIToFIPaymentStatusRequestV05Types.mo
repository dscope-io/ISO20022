module {
	...
	public type PaymentTransaction131 = {
		ClrSysRef : ?Text;
	...
	public type OriginalGroupInformation27 = {
		OrgnlNbOfTxs : ?Text;
		OrgnlCreDtTm : ?Int;
		OrgnlMsgNmId : Text;
		OrgnlMsgId : Text;
	...
	public type FIToFIPaymentStatusRequestV05 = {
		GrpHdr : GroupHeader91;
		SplmtryData : ?[SupplementaryData1];

		TxInf : ?[PaymentTransaction131];

		OrgnlGrpInf : ?[OriginalGroupInformation27];
