module {
	...
	public type CreditTransferTransaction56 = {
		InstrForCdtrAgt : ?[InstructionForCreditorAgent3];
	...
	public type FinancialInstitutionCreditTransferV10 = {
		CdtTrfTxInf : [CreditTransferTransaction56];
		GrpHdr : GroupHeader96;
		SplmtryData : ?[SupplementaryData1];
