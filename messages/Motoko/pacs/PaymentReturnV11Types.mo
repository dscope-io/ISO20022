module {
	...
	public type CreditTransferTransaction52 = {
		...
		PrvsInstgAgt2Acct : ?CashAccount40;
		...
		PrvsInstgAgt1Acct : ?CashAccount40;
		IntrmyAgt2Acct : ?CashAccount40;
		RmtInf : ?RemittanceInformation21;
		PrvsInstgAgt3Acct : ?CashAccount40;
	...
	public type OriginalTransactionReference36 = {
		...
		DbtrAcct : ?CashAccount40;
		UndrlygCstmrCdtTrf : ?CreditTransferTransaction52;
		DbtrAgt : ?BranchAndFinancialInstitutionIdentification6;
		IntrBkSttlmDt : ?Int;
		CdtrAcct : ?CashAccount40;
	...
	public type PaymentReturnReason6 = {
	...
	public type TransactionParties10 = {
		PrvsInstgAgt1 : ?BranchAndFinancialInstitutionIdentification6;
		PrvsInstgAgt2 : ?BranchAndFinancialInstitutionIdentification6;
		PrvsInstgAgt3 : ?BranchAndFinancialInstitutionIdentification6;
		Cdtr : Party40Choice;
	...
	public type PaymentTransaction133 = {
		ClrSysRef : ?Text;
		OrgnlTxRef : ?OriginalTransactionReference36;
		ChrgsInf : ?[Charges7];
		...
		InstdAgt : ?BranchAndFinancialInstitutionIdentification6;
		InstgAgt : ?BranchAndFinancialInstitutionIdentification6;
		RtrRsnInf : ?[PaymentReturnReason6];
	...
	public type OriginalGroupHeader18 = {
		RtrRsnInf : ?[PaymentReturnReason6];
	...
	public type PaymentReturnV11 = {
		GrpHdr : GroupHeader99;
		SplmtryData : ?[SupplementaryData1];

		TxInf : ?[PaymentTransaction133];
