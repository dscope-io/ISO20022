module {
	...
	public type CurrencyExchange13 = {
		SrcCcy : Text;
		UnitCcy : ?Text;
		TrgtCcy : Text;
		XchgRate : Float;
	...
	public type TrackerRecord1 = {
		Agt : BranchAndFinancialInstitutionIdentification6;
		ChrgsAmt : ?ActiveCurrencyAndAmount;
		XchgRateData : ?CurrencyExchange13;
		ChrgBr : ?ChargeBearerType1Code;
	};

	public type TrackerData1 = {
		TrckrRcrd : [TrackerRecord1];
		ConfdDt : DateAndDateTime2Choice;
		ConfdAmt : ActiveCurrencyAndAmount;
	};

	public type PaymentTransaction129 = {
		ClrSysRef : ?Text;
	...
	public type OriginalPaymentInstruction40 = {
		StsRsnInf : ?[StatusReasonInformation12];

		TxInfAndSts : ?[PaymentTransaction129];
	...
	public type OriginalGroupHeader17 = {
		StsRsnInf : ?[StatusReasonInformation12];
	...
	public type CustomerPaymentStatusReportV12 = {
		GrpHdr : GroupHeader86;
		SplmtryData : ?[SupplementaryData1];

		OrgnlPmtInfAndSts : ?[OriginalPaymentInstruction40];
