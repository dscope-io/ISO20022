module {
	...
	public type OriginalMandate8Choice = {
		OrgnlMndt : ?Mandate16;
		OrgnlMndtId : ?Text;
	};
	...
	public type AcceptanceResult6 = {
		RjctRsn : ?MandateReason1Choice;
		Accptd : ?boolean;
		AddtlRjctRsnInf : ?[Text];

	};

	public type MandateAcceptance7 = {
		SplmtryData : ?[SupplementaryData1];

		OrgnlMsgInf : ?OriginalMessageInformation1;
		OrgnlMndt : ?OriginalMandate8Choice;
		AccptncRslt : AcceptanceResult6;
	};

	public type MandateAcceptanceReportV07 = {
		GrpHdr : GroupHeader80;
		SplmtryData : ?[SupplementaryData1];

		UndrlygAccptncDtls : [MandateAcceptance7];
	};
