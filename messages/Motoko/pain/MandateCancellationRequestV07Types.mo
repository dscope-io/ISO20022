module {
	...
	public type MandateCancellationReason1 = {
	...
	public type MandateCancellation7 = {
		CxlRsn : MandateCancellationReason1;
	...
	public type MandateCancellationRequestV07 = {
		GrpHdr : GroupHeader80;
		SplmtryData : ?[SupplementaryData1];

		UndrlygCxlDtls : [MandateCancellation7];
	};
