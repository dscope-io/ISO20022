module {
	...
	public type MandateSuspensionReason1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type MandateSuspensionReason2 = {
		Rsn : MandateSuspensionReason1Choice;
		Orgtr : ?PartyIdentification135;
		AddtlInf : ?[Text];

	};

	public type MandateSuspension3 = {
		SspnsnReqId : Text;
		SplmtryData : ?[SupplementaryData1];

		OrgnlMsgInf : ?OriginalMessageInformation1;
		OrgnlMndt : OriginalMandate9Choice;
		SspnsnRsn : MandateSuspensionReason2;
	};

	public type MandateSuspensionRequestV03 = {
		GrpHdr : GroupHeader80;
		SplmtryData : ?[SupplementaryData1];

		UndrlygSspnsnDtls : [MandateSuspension3];
	};
