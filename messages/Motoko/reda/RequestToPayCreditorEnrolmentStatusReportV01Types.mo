module {
	...
	public type ServiceRequestStatus1Code = {
		#ACPT;
		#RJCT;
	};

	public type ServiceStatus1Choice = {
		Cd : ?ServiceRequestStatus1Code;
		Prtry : ?Text;
	};
	...
	public type CreditorEnrolmentStatusReason2Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type CreditorEnrolmentStatusReason2 = {
		Rsn : CreditorEnrolmentStatusReason2Choice;
		Orgtr : ?RTPPartyIdentification1;
		AddtlInf : ?[Text];

	};

	public type EnrolmentStatus2 = {
		Sts : ServiceStatus1Choice;
		OrgnlEnrlmntRef : ?OriginalEnrolment2Choice;
		OrgnlBizInstr : ?OriginalBusinessInstruction1;
		StsRsn : ?CreditorEnrolmentStatusReason2;
		SplmtryData : ?[SupplementaryData1];

		FctvEnrlmntDt : ?DateAndDateTime2Choice;
	};

	public type RequestToPayCreditorEnrolmentStatusReportV01 = {
		Hdr : EnrolmentHeader2;
		SplmtryData : ?[SupplementaryData1];

		OrgnlEnrlmntAndSts : [EnrolmentStatus2];
	};
