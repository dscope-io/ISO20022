module {
	...
	public type DebtorActivationCancellationReason1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type DebtorActivationCancellationReason2 = {
		Rsn : DebtorActivationCancellationReason1Choice;
	...
	public type DebtorActivationCancellation2 = {
		CxlRsn : ?DebtorActivationCancellationReason2;
	...
	public type RequestToPayDebtorActivationCancellationRequestV01 = {
		Hdr : ActivationHeader2;
		CxlData : [DebtorActivationCancellation2];
		SplmtryData : ?[SupplementaryData1];
