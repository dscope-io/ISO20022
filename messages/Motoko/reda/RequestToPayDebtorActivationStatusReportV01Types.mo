module {
	...
	public type DebtorActivationStatusReason1Choice = {
		Cd : ?Text;
		Prtry : ?Text;
	};

	public type DebtorActivationStatusReason2 = {
		Rsn : DebtorActivationStatusReason1Choice;
	...
	public type ActivationStatus2 = {
		Sts : ServiceStatus1Choice;
		OrgnlBizInstr : ?OriginalBusinessInstruction1;
		StsRsn : ?DebtorActivationStatusReason2;
		FctvActvtnDt : ?DateAndDateTime2Choice;
		SplmtryData : ?[SupplementaryData1];

		OrgnlActvtnRef : ?OriginalActivation2Choice;
	};

	public type RequestToPayDebtorActivationStatusReportV01 = {
		Hdr : ActivationHeader2;
		OrgnlActvtnAndSts : [ActivationStatus2];
		SplmtryData : ?[SupplementaryData1];
