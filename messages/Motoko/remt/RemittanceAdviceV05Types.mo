module {
	...
	public type TransactionReferences5 = {
	...
	public type RemittanceInformation20 = {
		Strd : ?[StructuredRemittanceInformation17];

		Ustrd : ?[Text];

		OrgnlPmtInf : OriginalPaymentInformation9;
		RmtId : ?Text;
	};

	public type RemittanceAdviceV05 = {
		GrpHdr : GroupHeader79;
		SplmtryData : ?[SupplementaryData1];

		RmtInf : [RemittanceInformation20];
	};
